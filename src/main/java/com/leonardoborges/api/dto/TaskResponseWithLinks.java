...
/**
 * Task response with HATEOAS links.
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Task response with HATEOAS links")
public class TaskResponseWithLinks {
    
    @Schema(description = "Task data")
    private TaskResponse task;
    
    @Schema(description = "HATEOAS links for navigation")
